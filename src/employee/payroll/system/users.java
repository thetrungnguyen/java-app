...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin đăng nhập", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Adobe Arabic", 1, 18))); // NOI18N

        jLabel1.setText("Loại TK:");
    ...
    private void cmd_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_deleteActionPerformed
        // TODO add your handling code here:
         ...
         int p = JOptionPane.showConfirmDialog(null, "Bạn muốn xóa tài khoản?","Xóa",JOptionPane.YES_NO_OPTION);
        if(p==0){
    ...
    private void cmd_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_updateActionPerformed
        // TODO add your handling code here:
        int p = JOptionPane.showConfirmDialog(null, "Bạn có muốn sửa thông tin?","Chỉnh Sửa",JOptionPane.YES_NO_OPTION);
        if(p==0){
         try{
   ...
   int p = JOptionPane.showConfirmDialog(null, "Bạn muốn lưu thay đổi?","Thêm Người Dùng",JOptionPane.YES_NO_OPTION);
